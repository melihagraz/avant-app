...
const INITIAL_MSGS = [
  { id: '1', me: true, text: 'Merhaba! Profil fotograflarin harika', time: '14:20' },
  { id: '2', me: false, text: 'Tesekkurler! Hobi olarak yapiyorum', time: '14:23' },
  { id: '3', me: true, text: "Pazar sabahi pazar gezmek diyorsun bio'nda — hangi pazari onerirsin?", time: '14:28' },
  { id: '4', me: false, text: 'Pazar sabahi pazar firsati haha. Beraber gidebiliriz bir gun!', time: '14:32' },
];

const AGENT_SUGGESTIONS = [
  { icon: '🗺️', text: 'Bu hafta sonu pazar gezisi yapalim mi? Bildigim harika bir yer var.' },
  { icon: '📸', text: 'Fotograf icin en cok hangi anlari cekmeyi seviyorsun?' },
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.chatHName}>Zeynep</Text>
        ...
        <View style={{ flex: 1, position: 'relative' }}>
          ...
          >
            {messages.map((msg) => (
              <Animated.View
                key={msg.id}
                style={[styles.msg, msg.me ? styles.msgMe : styles.msgThem]}
              >
                <View style={[styles.bubble, msg.me ? styles.bubbleMe : styles.bubbleThem]}>
                  <Text style={[styles.bubbleText, msg.me && { color: Colors.goldText, fontWeight: '500' }]}>
                    {msg.text}
                  </Text>
                </View>
                <Text style={[styles.msgTime, msg.me ? { textAlign: 'right', paddingRight: 4 } : { paddingLeft: 4 }]}>
                  {msg.time}
                </Text>
              </Animated.View>
            ))}
          ...
          {agentOpen && (
            ...
            >
              ...
              <Text style={styles.agentTip}>%87 uyumluluk - Ortak konu: fotograf + pazar</Text>
            </Animated.View>
          )}
        </View>
